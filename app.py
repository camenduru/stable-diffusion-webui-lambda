...
print("wget done!")
os.system(f"sudo git config --global --add safe.directory '*'")
os.system(f"sudo python launch.py --listen --port 8266 --enable-insecure-extension-access --theme dark --gradio-queue")